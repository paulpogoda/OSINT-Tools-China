...
- [Overseas reachability of official Chinese verification portals](https://currawongweb.com/verify/china-official-source-availability/). Measured data on which official portals actually answer from nodes outside mainland China - GSXT refused every overseas node tested; the court judgement-defaulter database answered Hong Kong and refused nodes in 19 other countries. Relevant before assuming the links above will open for you.
